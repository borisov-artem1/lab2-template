...
if __name__ == '__main__':
    ...
    uvicorn.run(
        "main:app", 
        host=settings["services"]["reservation"]["host"], 
        port=settings["services"]["reservation"]["port"],
        log_level=settings["services"]["reservation"]["log_level"],
        reload=settings["services"]["reservation"]["reload"]
    )
