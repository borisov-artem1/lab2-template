...
if __name__ == '__main__':
    ...
    uvicorn.run(
        "main:app", 
        host=settings["services"]["rating"]["host"], 
        port=settings["services"]["rating"]["port"],
        log_level=settings["services"]["rating"]["log_level"],
        reload=settings["services"]["rating"]["reload"]
    )
